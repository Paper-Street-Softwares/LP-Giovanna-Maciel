...
export default function NavbarSocial({ colorMode, mode }) {
  ...
  const getNavbarClasses = () => {
    ...
    // default
    return scrolling
      ? "bg-gradient-to-b from-bgSectionDark to-bgSectionDark bg-opacity-100 shadow-lg border-b-[1px] border-white"
      : "bg-gradient-to-b from-bgSectionDark to-bgSectionDark border-b-[1px] border-none";
  };
            ...
            <img
              ...
              className={`bg-transparent ${
                scrolling
                  ...
                  : "my-[20px] w-[60%] phone2:w-[60%] phone3:w-[60%] tablet1:w-[60%] tablet2:w-[55%] desktop1:w-[55%] desktop2:w-[60%]"
