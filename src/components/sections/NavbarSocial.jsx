...
export default function NavbarSocial({ colorMode, mode }) {
  ...
  const getNavbarClasses = () => {
    ...
    // default
    return scrolling
      ? "bg-gradient-to-b from-black/40 to-bgSectionDark bg-opacity-100 shadow-lg border-b-[1px] border-primary"
      : "bg-gradient-to-b from-black/40 to-transparent border-b-[1px] border-none";
  };
